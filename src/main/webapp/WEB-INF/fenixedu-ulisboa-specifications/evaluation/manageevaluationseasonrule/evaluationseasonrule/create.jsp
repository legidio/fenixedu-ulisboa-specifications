...
<form name='form' method="post" class="form-horizontal"
	...
	action='${pageContext.request.contextPath}<%=EvaluationSeasonRuleController.CREATE_URL%>'>

	<input type="hidden" name="postback"
		value='${pageContext.request.contextPath}<%=EvaluationSeasonRuleController.CREATEPOSTBACK_URL%>' />
