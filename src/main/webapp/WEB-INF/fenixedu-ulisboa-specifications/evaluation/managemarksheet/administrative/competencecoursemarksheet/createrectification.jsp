...
<div class="page-header">
	<h1>
		<spring:message code="label.evaluation.manageMarkSheet.administrative.createRectification" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class=""
		href="${pageContext.request.contextPath}<%=CompetenceCourseMarkSheetController.READ_URL%>"><spring:message
...
<form name='form' method="post" class="form-horizontal" ng-app="angularAppCompetenceCourseMarkSheet"
	...
	action='${pageContext.request.contextPath}<%=CompetenceCourseMarkSheetController.CREATERECTIFICATION_URL%>'>

	<input type="hidden" name="postback"
		value='${pageContext.request.contextPath}<%=CompetenceCourseMarkSheetController.CREATERECTIFICATIONPOSTBACK_URL%>' />
