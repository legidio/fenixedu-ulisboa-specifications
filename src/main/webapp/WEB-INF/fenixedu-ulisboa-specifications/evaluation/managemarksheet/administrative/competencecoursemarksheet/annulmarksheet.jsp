...
<div class="page-header">
	<h1>
		<spring:message code="label.evaluation.manageMarkSheet.administrative.annulMarkSheet" />
		<small></small>
	</h1>
</div>
...
<form name='form' method="post" class="form-horizontal" ng-app="angularAppCompetenceCourseMarkSheet"
	...
	action='${pageContext.request.contextPath}<%=CompetenceCourseMarkSheetController.ANNULMARKSHEET_URL%>${competenceCourseMarkSheet.externalId}'>

	<input type="hidden" name="postback"
		value='${pageContext.request.contextPath}<%=CompetenceCourseMarkSheetController.ANNULMARKSHEETPOSTBACK_URL%>${competenceCourseMarkSheet.externalId}' />
		...
		<div class="panel-body">
			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.CompetenceCourseMarkSheet.reason" />
				</div>

				<div class="col-sm-10">
					<input id="competenceCourseMarkSheet_reason" class="form-control" type="text" ng-model="object.reason" name="reason" />
				</div>
			</div>
		</div>
